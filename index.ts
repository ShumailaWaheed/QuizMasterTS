...
const showAnimatedMessage = async (message: string, color: string = 'blue') => {
  console.clear();
...
const isAnswerCorrect = (givenAnswer: string, expectedAnswer: string): boolean => {
...
const askQuestions = async (questions: any[]) => {
